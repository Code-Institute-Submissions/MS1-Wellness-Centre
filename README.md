...
On some mobile devices when the device is sideways the page doesnt fill the whole screen leaving a blank white area on the sides of the screen and on mobile devices and tablets the bullet point show the original black not orange colour. ![bullet points](assets/images/bullet-points.jpeg)
